...
void scene2() {
    if (!isRainEnabled) {
        gradSky(0.44f,0.74f,0.95f, 0.68f,0.89f,0.99f);
        sun(980+sunHorizontalOffset*0.35f,610);
        cloud(220+cloudOffsetX_layerA,610);
        cloud(560+cloudOffsetX_layerB,640);
    } else {
        gradSky(0.26f,0.28f,0.32f, 0.36f,0.38f,0.42f);
        glColor3f(0.28f,0.30f,0.34f);
        ellipse(240+cloudOffsetX_layerA*0.32f,620,170,45,36);
        ellipse(640+cloudOffsetX_layerB*0.30f,646,190,50,36);
    }
    ...
    for (float dx=-80.0f + roadDashOffset_scene2; dx<1280.0f; dx+=92.0f) {
        rect(dx,171,54,4);
        rect(dx+24,282,54,4);
    }
    glColor3f(0.24f,0.52f,0.26f); rect(0,0,1280,120);
    glColor3f(0.30f,0.58f,0.34f);
    for (float x=0; x<1280; x+=86) ellipse(x+26,112,38,10,18);
    ...
    car(trafficCarPositionX_scene2_A,168+bobA,0.88f,0.22f,0.18f, trafficCarWheelAngle_scene2_A, false,false,true);
    bus(trafficCarPositionX_scene2_B,224+bobB,0.92f,0.68f,0.18f, trafficCarWheelAngle_scene2_B, false);
    deliveryVan(trafficCarPositionX_scene2_C,294+bobC,0.88f,0.88f,0.84f, trafficCarWheelAngle_scene2_C, true);
}
